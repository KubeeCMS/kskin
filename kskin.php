...
final class Plus_admin {
    ...
    public function define_constants() {
        ...
        define( 'PLUS_ADMIN_PATH', dirname( PLUS_ADMIN_FILE ) );
        define( 'PLUS_ADMIN_INCLUDES', PLUS_ADMIN_PATH . '/includes' );
        define( 'PLUS_ADMIN_URL', plugins_url( '', PLUS_ADMIN_FILE ) );
        define( 'PLUS_ADMIN_ASSETS', PLUS_ADMIN_URL . '/assets' );
    }
